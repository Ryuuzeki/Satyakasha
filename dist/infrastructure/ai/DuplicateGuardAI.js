...
exports.DuplicateGuardAI = void 0;
const DocumentType_1 = require("../../domain/enums/DocumentType");
class DuplicateGuardAI {
    /**
     ...
     */
    async validate(ipfsCID, metadata, type) {
        const anomalies = [];
        ...
        switch (type) {
            case DocumentType_1.DocumentType.LEGAL:
                this.validateLegalMetadata(metadata, anomalies);
                break;
            case DocumentType_1.DocumentType.ACADEMIC:
                this.validateAcademicMetadata(metadata, anomalies);
                break;
            case DocumentType_1.DocumentType.CONSTRUCTION:
    ...
    validateLegalMetadata(metadata, anomalies) {
    ...
    validateAcademicMetadata(metadata, anomalies) {
    ...
    validateConstructionMetadata(metadata, anomalies) {
    ...
    checkForDuplicates(metadata, anomalies) {
...
exports.DuplicateGuardAI = DuplicateGuardAI;
