...
class PeerServer extends events_1.EventEmitter {
    constructor(config) {
        ...
        this._scServer = (0, socketcluster_server_1.attach)(this._httpServer, {
    ...
    _validateQueryObject(socket) {
        ...
        if (queryObject.nonce === this._nodeInfo.nonce) {
            ...
            this._peerBook.removePeer({
                peerId: (0, utils_1.constructPeerId)(socket.remoteAddress, selfport),
    ...
    _constructPeerInfoForInboundConnection(queryObject, socket) {
        ...
        const peerId = (0, utils_1.constructPeerId)(socket.remoteAddress, remoteport);
            ...
            ? {
                ...
                internalState: {
                    ...(peerInPeerBook.internalState
                        ? peerInPeerBook.internalState
                        : (0, utils_1.assignInternalInfo)(peerInPeerBook, this._secret)),
        ...
        try {
            const validPeerInfo = (0, utils_1.validatePeerInfo)(incomingPeerInfo, this._maxPeerInfoSize ? this._maxPeerInfoSize : constants_1.DEFAULT_MAX_PEER_INFO_SIZE);
            return validPeerInfo;
        }
        catch (error) {
            this._disconnectSocketDueToFailedHandshake(socket, constants_1.INCOMPATIBLE_PEER_INFO_CODE, error instanceof Error ? error.message : '');
            return undefined;
        }
    }
    ...
    _handleIncomingPayload(ws, _req) {
        ws.on('message', (message) => {
            ...
            const peerId = (0, utils_1.constructPeerId)(peerIpAddress, port);
            try {
                const parsed = JSON.parse(message);
                (0, utils_1.validatePacket)(parsed);
                ...
                if ((parsed.event && typeof parsed.event !== 'string') ||
                    ...
                    throw new errors_1.InvalidPayloadError('Received invalid transactions', parsed);
                }
