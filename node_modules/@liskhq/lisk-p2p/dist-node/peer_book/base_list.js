...
class BaseList {
    ...
    get peerList() {
        ...
        for (const peerList of [...this.bucketIdToBucket.values()]) {
            for (const peer of [...peerList.values()]) {
                peerListMap.push((0, utils_1.sanitizeEnhancedPeerInfo)(peer));
            }
        }
        return peerListMap;
    }
    ...
    getPeer(incomingPeerId) {
        ...
        return (0, utils_1.sanitizeEnhancedPeerInfo)(peerInfo);
    }
    ...
    makeSpace(bucket) {
        return (0, utils_1.evictPeerRandomlyFromBucket)(bucket);
    }
    ...
    calculateBucket(targetAddress, sourceAddress) {
        const bucketId = (0, utils_1.getBucketId)({
