...
class P2P extends events_1.EventEmitter {
    constructor(config) {
        ...
        this._handleInboundPeerConnect = (incomingPeerConnection) => {
            if (!(0, lisk_validator_1.isIPV4)(incomingPeerConnection.socket.remoteAddress)) {
        ...
        this._nodeInfo = {
            ...config.nodeInfo,
            nonce: lisk_cryptography_1.utils.getRandomBytes(constants_1.DEFAULT_NONCE_LENGTH_BYTES).toString('hex'),
        };
    ...
    _handleGetNodeInfo(request) {
        ...
        const encodedNodeInfo = (0, codec_1.encodeNodeInfo)(this._rpcSchemas.nodeInfo, this._nodeInfo);
    ...
    _handleGetPeersRequest(request) {
        ...
        const encodedPeersList = sanitizedPeerInfoList.map(peer => (0, codec_1.encodePeerInfo)(this._rpcSchemas.peerInfo, peer));
