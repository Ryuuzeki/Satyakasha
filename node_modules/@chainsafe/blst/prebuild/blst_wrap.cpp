...
static SwigV8ReturnValue exports_BLST_SUCCESS_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
...
static SwigV8ReturnValue exports_BLST_BAD_ENCODING_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  v8::Isolate* isolate = info.GetIsolate();
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue exports_BLST_POINT_NOT_ON_CURVE_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  v8::Isolate* isolate = info.GetIsolate();
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue exports_BLST_POINT_NOT_IN_GROUP_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  v8::Isolate* isolate = info.GetIsolate();
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue exports_BLST_AGGR_TYPE_MISMATCH_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  v8::Isolate* isolate = info.GetIsolate();
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue exports_BLST_VERIFY_FAIL_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  v8::Isolate* isolate = info.GetIsolate();
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue exports_BLST_PK_IS_INFINITY_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  v8::Isolate* isolate = info.GetIsolate();
  SWIGV8_HANDLESCOPE();
...
static swig_type_info _swigt__p_BLST_ERROR = {"_p_BLST_ERROR", "BLST_ERROR *|enum BLST_ERROR *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_blst__P1 = {"_p_blst__P1", "p_blst__P1|blst::P1 *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_blst__P1_Affine = {"_p_blst__P1_Affine", "blst::P1_Affine *|p_blst__P1_Affine", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_blst__P2 = {"_p_blst__P2", "p_blst__P2|blst::P2 *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_blst__P2_Affine = {"_p_blst__P2_Affine", "blst::P2_Affine *|p_blst__P2_Affine", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_blst__PT = {"_p_blst__PT", "p_blst__PT|blst::PT *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_blst__Pairing = {"_p_blst__Pairing", "blst::Pairing *|p_blst__Pairing", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_blst__Scalar = {"_p_blst__Scalar", "p_blst__Scalar|blst::Scalar *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_blst__SecretKey = {"_p_blst__SecretKey", "p_blst__SecretKey|blst::SecretKey *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
...
static swig_type_info _swigt__p_int = {"_p_int", "int32_t *|int_fast16_t *|int_fast32_t *|int_least32_t *|intptr_t *|int *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_long_long = {"_p_long_long", "int64_t *|int_fast64_t *|int_least64_t *|intmax_t *|long long *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_short = {"_p_short", "int16_t *|int_least16_t *|short *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_signed_char = {"_p_signed_char", "int8_t *|int_fast8_t *|int_least8_t *|signed char *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_unsigned_char = {"_p_unsigned_char", "uint8_t *|uint_fast8_t *|uint_least8_t *|unsigned char *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_unsigned_int = {"_p_unsigned_int", "uint32_t *|uint_fast16_t *|uint_fast32_t *|uint_least32_t *|uintptr_t *|unsigned int *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_unsigned_long_long = {"_p_unsigned_long_long", "uint64_t *|uint_fast64_t *|uint_least64_t *|uintmax_t *|unsigned long long *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
static swig_type_info _swigt__p_unsigned_short = {"_p_unsigned_short", "uint16_t *|uint_least16_t *|unsigned short *", 0, 0, (SWIG_CLIENT_DATA_TYPE*)0, 0};
...
SWIGV8_FUNCTION_TEMPLATE _exports_Scalar_class = SWIGV8_CreateClassTemplate("_exports_Scalar", isolate, v8_swig_types_as_data);
_exports_Scalar_clientData.index = &SWIGTYPE_p_blst__Scalar - &swig_types[0];
_exports_Scalar_clientData.dtor = _wrap_delete_Scalar;
_exports_Scalar_clientData.SetType(_exports_Scalar_class, isolate, v8_swig_types);
...
SWIGTYPE_p_blst__Pairing->clientdata = &_exports_Pairing_clientData;
  ...
  SWIGV8_AddStaticVariable(exports_obj, "BLST_SUCCESS", exports_BLST_SUCCESS_get, JS_veto_set_variable, context, v8_swig_types_as_data);
SWIGV8_AddStaticVariable(exports_obj, "BLST_BAD_ENCODING", exports_BLST_BAD_ENCODING_get, JS_veto_set_variable, context, v8_swig_types_as_data);
SWIGV8_AddStaticVariable(exports_obj, "BLST_POINT_NOT_ON_CURVE", exports_BLST_POINT_NOT_ON_CURVE_get, JS_veto_set_variable, context, v8_swig_types_as_data);
SWIGV8_AddStaticVariable(exports_obj, "BLST_POINT_NOT_IN_GROUP", exports_BLST_POINT_NOT_IN_GROUP_get, JS_veto_set_variable, context, v8_swig_types_as_data);
SWIGV8_AddStaticVariable(exports_obj, "BLST_AGGR_TYPE_MISMATCH", exports_BLST_AGGR_TYPE_MISMATCH_get, JS_veto_set_variable, context, v8_swig_types_as_data);
SWIGV8_AddStaticVariable(exports_obj, "BLST_VERIFY_FAIL", exports_BLST_VERIFY_FAIL_get, JS_veto_set_variable, context, v8_swig_types_as_data);
SWIGV8_AddStaticVariable(exports_obj, "BLST_PK_IS_INFINITY", exports_BLST_PK_IS_INFINITY_get, JS_veto_set_variable, context, v8_swig_types_as_data);
...
SWIGV8_AddMemberFunction(_exports_SecretKey_class, "keygen_v3", _wrap_SecretKey__wrap_SecretKey_keygen_v3, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_SecretKey_class, "keygen_v4_5", _wrap_SecretKey__wrap_SecretKey_keygen_v4_5, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_SecretKey_class, "keygen_v5", _wrap_SecretKey__wrap_SecretKey_keygen_v5, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_SecretKey_class, "derive_master_eip2333", _wrap_SecretKey_derive_master_eip2333, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_SecretKey_class, "derive_child_eip2333", _wrap_SecretKey_derive_child_eip2333, isolate, v8_swig_types_as_data);
...
SWIGV8_AddMemberFunction(_exports_Scalar_class, "hash_to", _wrap_Scalar__wrap_Scalar_hash_to, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_Scalar_class, "dup", _wrap_Scalar_dup, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_Scalar_class, "from_bendian", _wrap_Scalar_from_bendian, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_Scalar_class, "from_lendian", _wrap_Scalar_from_lendian, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_Scalar_class, "to_bendian", _wrap_Scalar_to_bendian, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_Scalar_class, "to_lendian", _wrap_Scalar_to_lendian, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_Scalar_class, "add", _wrap_Scalar__wrap_Scalar_add, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_Scalar_class, "sub", _wrap_Scalar_sub, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_Scalar_class, "mul", _wrap_Scalar_mul, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_Scalar_class, "inverse", _wrap_Scalar_inverse, isolate, v8_swig_types_as_data);
...
SWIGV8_AddMemberFunction(_exports_P1_class, "sign_with", _wrap_P1__wrap_P1_sign_with, isolate, v8_swig_types_as_data);
...
SWIGV8_AddMemberFunction(_exports_P1_class, "mult", _wrap_P1__wrap_P1_mult, isolate, v8_swig_types_as_data);
...
SWIGV8_AddMemberFunction(_exports_P2_class, "sign_with", _wrap_P2__wrap_P2_sign_with, isolate, v8_swig_types_as_data);
...
SWIGV8_AddMemberFunction(_exports_P2_class, "mult", _wrap_P2__wrap_P2_mult, isolate, v8_swig_types_as_data);
...
SWIGV8_AddMemberFunction(_exports_PT_class, "in_group", _wrap_PT_in_group, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_PT_class, "to_bendian", _wrap_PT_to_bendian, isolate, v8_swig_types_as_data);
...
SWIGV8_AddMemberFunction(_exports_Pairing_class, "raw_aggregate", _wrap_Pairing_raw_aggregate, isolate, v8_swig_types_as_data);
SWIGV8_AddMemberFunction(_exports_Pairing_class, "as_fp12", _wrap_Pairing_as_fp12, isolate, v8_swig_types_as_data);
...
SWIGV8_FUNCTION_TEMPLATE _exports_Scalar_class_0 = SWIGV8_CreateClassTemplate("Scalar", isolate, v8_swig_types_as_data);
_exports_Scalar_class_0->SetCallHandler(_wrap_new_Scalar, v8_swig_types_as_data);
...
SWIGV8_AddStaticFunction(_exports_PT_obj, "finalverify", _wrap_PT_finalverify, context, v8_swig_types_as_data);
SWIGV8_AddStaticFunction(_exports_PT_obj, "one", _wrap_PT_one, context, v8_swig_types_as_data);
